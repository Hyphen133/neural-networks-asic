module tt_um_wakeword (clk,
 ...
 sg13g2_inv_1 _1044_ (.Y(_0508_),
    .A(net71));
 sg13g2_inv_1 _1045_ (.Y(_0509_),
    .A(net83));
 sg13g2_inv_1 _1046_ (.Y(_0510_),
    .A(net79));
 sg13g2_inv_1 _1047_ (.Y(_0511_),
    .A(net68));
 sg13g2_inv_1 _1048_ (.Y(_0512_),
    .A(uo_out[7]));
 sg13g2_inv_1 _1049_ (.Y(_0513_),
    .A(uo_out[6]));
 sg13g2_inv_1 _1050_ (.Y(_0514_),
    .A(uo_out[4]));
 sg13g2_inv_1 _1051_ (.Y(_0515_),
    .A(\fmax[1][0] ));
 sg13g2_inv_1 _1052_ (.Y(_0516_),
    .A(\fmax[3][0] ));
 sg13g2_inv_1 _1053_ (.Y(_0000_),
    .A(net307));
 sg13g2_inv_1 _1054_ (.Y(_0517_),
    .A(net372));
 sg13g2_inv_1 _1055_ (.Y(_0518_),
    .A(net135));
 sg13g2_inv_1 _1056_ (.Y(_0519_),
    .A(net139));
 sg13g2_inv_1 _1057_ (.Y(_0520_),
    .A(net408));
 sg13g2_inv_1 _1058_ (.Y(_0521_),
    .A(net74));
 sg13g2_inv_1 _1059_ (.Y(_0522_),
    .A(\casc_st[1] ));
 sg13g2_inv_1 _1060_ (.Y(_0523_),
    .A(\casc_st[0] ));
 sg13g2_inv_1 _1061_ (.Y(_0524_),
    .A(net368));
 sg13g2_inv_1 _1062_ (.Y(_0525_),
    .A(net337));
 sg13g2_inv_1 _1063_ (.Y(_0526_),
    .A(\casc_st[8] ));
 sg13g2_inv_1 _1064_ (.Y(_0527_),
    .A(net141));
 sg13g2_inv_1 _1065_ (.Y(_0528_),
    .A(net137));
 sg13g2_inv_1 _1066_ (.Y(_0529_),
    .A(net133));
 sg13g2_inv_1 _1067_ (.Y(_0530_),
    .A(net131));
 ...
 sg13g2_nor3_1 _1076_ (.A(\hold[0] ),
    ...
    .C(net363),
    .Y(_0535_));
 sg13g2_inv_1 _1077_ (.Y(_0536_),
    .A(_0535_));
 sg13g2_nand2b_1 _1078_ (.Y(_0537_),
    .B(_0535_),
    .A_N(net348));
 sg13g2_or2_1 _1079_ (.X(detect),
    .B(_0537_),
    .A(net168));
 ...
 sg13g2_nand3_1 _1097_ (.B(net53),
    ...
    .A(_0510_),
    .Y(_0554_));
 sg13g2_a21oi_1 _1098_ (.A1(net85),
    .A2(net83),
    .Y(_0555_),
    .B1(net80));
 sg13g2_nand2_1 _1099_ (.Y(_0556_),
    .A(_0510_),
    .B(_0545_));
 sg13g2_a21oi_1 _1100_ (.A1(net53),
    .A2(_0555_),
    .Y(_0557_),
    .B1(net71));
 ...
 sg13g2_o21ai_1 _1116_ (.B1(net68),
    ...
    .A1(net71),
    .A2(_0561_));
 sg13g2_a21oi_1 _1117_ (.A1(_0571_),
    .A2(_0572_),
    .Y(_0574_),
    .B1(_0573_));
 sg13g2_a21oi_1 _1118_ (.A1(_0558_),
    .A2(_0568_),
    .Y(_0575_),
    .B1(_0574_));
 sg13g2_a21oi_1 _1119_ (.A1(net82),
    .A2(net52),
    .Y(_0576_),
    .B1(_0564_));
 ...
 sg13g2_o21ai_1 _1121_ (.B1(net63),
    ...
    .A1(net78),
    .A2(net53));
 sg13g2_a21oi_1 _1122_ (.A1(net79),
    .A2(net50),
    .Y(_0579_),
    .B1(net63));
 sg13g2_a21oi_1 _1123_ (.A1(net71),
    .A2(_0565_),
    .Y(_0580_),
    .B1(net68));
 ...
 sg13g2_nor2_1 _1127_ (.A(net70),
    .B(net53),
    .Y(_0584_));
 sg13g2_a21oi_1 _1128_ (.A1(net82),
    .A2(net52),
    .Y(_0585_),
    .B1(net63));
 ...
 sg13g2_a22oi_1 _1142_ (.Y(_0599_),
    ...
    .A2(_0544_),
    .A1(_0510_));
 sg13g2_a21oi_1 _1143_ (.A1(net71),
    .A2(_0599_),
    .Y(_0600_),
    .B1(_0577_));
 ...
 sg13g2_o21ai_1 _1146_ (.B1(_0602_),
    ...
    .A1(_0594_),
    .A2(_0597_));
 sg13g2_inv_1 _1147_ (.Y(_0604_),
    .A(net16));
 sg13g2_nor2_1 _1148_ (.A(_0548_),
    .B(_0551_),
    .Y(_0605_));
 sg13g2_or2_1 _1149_ (.X(_0606_),
    .B(_0569_),
    .A(net81));
 sg13g2_mux2_1 _1150_ (.A0(_0569_),
    ...
    .S(net80),
    .X(_0607_));
 sg13g2_a21oi_1 _1151_ (.A1(net54),
    .A2(_0607_),
    .Y(_0608_),
    .B1(_0605_));
 ...
 sg13g2_nor2_1 _1163_ (.A(_0563_),
    .B(_0619_),
    .Y(_0620_));
 sg13g2_a21oi_1 _1164_ (.A1(net52),
    .A2(_0618_),
    .Y(_0621_),
    .B1(net63));
 sg13g2_a221oi_1 _1165_ (.B2(_0621_),
    .C1(_0511_),
    .B1(_0620_),
    .A1(_0584_),
    .Y(_0622_),
 ...
 sg13g2_nand2_1 _1173_ (.Y(_0630_),
    .A(uo_out[6]),
    .B(net67));
 sg13g2_a21oi_1 _1174_ (.A1(uo_out[6]),
    .A2(net67),
    .Y(_0631_),
    .B1(uo_out[7]));
 ...
 sg13g2_nor2_1 _1183_ (.A(_0547_),
    .B(_0577_),
    .Y(_0640_));
 sg13g2_a21oi_1 _1184_ (.A1(_0567_),
    .A2(_0640_),
    .Y(_0641_),
    .B1(_0596_));
 ...
 sg13g2_o21ai_1 _1190_ (.B1(net71),
    ...
    .A1(_0607_),
    .A2(_0619_));
 sg13g2_a21oi_1 _1191_ (.A1(net80),
    .A2(_0553_),
    .Y(_0648_),
    .B1(_0555_));
 ...
 sg13g2_a22oi_1 _1194_ (.Y(_0651_),
    ...
    .A2(_0647_),
    .A1(_0558_));
 sg13g2_a21oi_1 _1195_ (.A1(\fmax[1][2] ),
    .A2(\fmax[1][1] ),
    .Y(_0652_),
    .B1(_0651_));
 ...
 sg13g2_nor2b_1 _1206_ (.A(\fmax[1][1] ),
    .B_N(_0651_),
    .Y(_0663_));
 sg13g2_a21oi_1 _1207_ (.A1(\fmax[1][1] ),
    .A2(_0653_),
    .Y(_0664_),
    .B1(_0663_));
 ...
 sg13g2_nand2_1 _1217_ (.Y(_0674_),
    .A(uo_out[4]),
    .B(net15));
 sg13g2_a21oi_1 _1218_ (.A1(uo_out[4]),
    .A2(net15),
    .Y(_0675_),
    .B1(_0515_));
 sg13g2_a221oi_1 _1219_ (.B2(net15),
    .C1(_0670_),
    .B1(_0668_),
    .A1(\fmax[1][1] ),
    .Y(_0676_),
 ...
 sg13g2_xnor2_1 _1224_ (.Y(_0681_),
    .A(_0662_),
    .B(_0665_));
 sg13g2_a21oi_1 _1225_ (.A1(_0679_),
    .A2(_0680_),
    .Y(_0682_),
    .B1(_0666_));
 ...
 sg13g2_nor2_1 _1227_ (.A(net12),
    .B(_0646_),
    .Y(_0684_));
 sg13g2_a21oi_1 _1228_ (.A1(net12),
    .A2(_0683_),
    .Y(_0685_),
    .B1(_0684_));
 sg13g2_a21oi_1 _1229_ (.A1(net81),
    .A2(_0544_),
    .Y(_0686_),
    .B1(net28));
 sg13g2_a21oi_1 _1230_ (.A1(net51),
    .A2(_0556_),
    .Y(_0687_),
    .B1(net71));
 ...
 sg13g2_nand3_1 _1233_ (.B(_0688_),
    ...
    .A(net69),
    .Y(_0690_));
 sg13g2_a21oi_1 _1234_ (.A1(net54),
    .A2(_0555_),
    .Y(_0691_),
    .B1(\c_hd[1] ));
 sg13g2_a21oi_1 _1235_ (.A1(_0581_),
    .A2(_0691_),
    .Y(_0692_),
    .B1(_0624_));
 sg13g2_a22oi_1 _1236_ (.Y(_0693_),
    ...
    .A2(_0686_),
    .A1(_0636_));
 sg13g2_a21oi_1 _1237_ (.A1(\fmax[2][2] ),
    .A2(\fmax[2][1] ),
    .Y(_0694_),
    .B1(_0693_));
 ...
 sg13g2_nor2_1 _1249_ (.A(net12),
    .B(_0662_),
    .Y(_0706_));
 sg13g2_a21oi_1 _1250_ (.A1(net12),
    .A2(_0705_),
    .Y(_0707_),
    .B1(_0706_));
 ...
 sg13g2_a21o_1 _1252_ (.A2(_0701_),
    ...
    .B1(_0702_),
    .X(_0709_));
 sg13g2_a221oi_1 _1253_ (.B2(_0677_),
    .C1(_0515_),
    .B1(_0673_),
    .A1(uo_out[4]),
    .Y(_0710_),
    .A2(net15));
 sg13g2_a21oi_1 _1254_ (.A1(net15),
    .A2(_0668_),
    .Y(_0711_),
    .B1(net12));
 sg13g2_inv_1 _1255_ (.Y(_0712_),
    .A(_0711_));
 ...
 sg13g2_xor2_1 _1265_ (.B(_0707_),
    .A(_0704_),
    .X(_0722_));
 sg13g2_a21oi_1 _1266_ (.A1(_0721_),
    .A2(_0722_),
    .Y(_0723_),
    .B1(_0708_));
 ...
 sg13g2_nor2_1 _1268_ (.A(net16),
    .B(_0685_),
    .Y(_0725_));
 sg13g2_a21oi_1 _1269_ (.A1(net16),
    .A2(_0724_),
    .Y(_0726_),
    .B1(_0725_));
 sg13g2_inv_1 _1270_ (.Y(_0727_),
    .A(_0726_));
 sg13g2_or2_1 _1271_ (.X(_0728_),
    .B(_0726_),
    .A(_0591_));
 ...
 sg13g2_nor2_1 _1279_ (.A(_0733_),
    .B(_0735_),
    .Y(_0736_));
 sg13g2_a21oi_1 _1280_ (.A1(\fmax[3][0] ),
    .A2(_0729_),
    .Y(_0737_),
    .B1(_0731_));
 ...
 sg13g2_nand3_1 _1283_ (.B(_0720_),
    ...
    .A(net16),
    .Y(_0740_));
 sg13g2_a21oi_1 _1284_ (.A1(_0739_),
    .A2(_0740_),
    .Y(_0741_),
    .B1(_0737_));
 ...
 sg13g2_xor2_1 _1292_ (.B(_0735_),
    .A(_0733_),
    .X(_0749_));
 sg13g2_a21oi_1 _1293_ (.A1(_0748_),
    .A2(_0749_),
    .Y(_0750_),
    .B1(_0736_));
 ...
 sg13g2_o21ai_1 _1307_ (.B1(_0757_),
    ...
    .A1(_0758_),
    .A2(_0763_));
 sg13g2_inv_1 _1308_ (.Y(_0765_),
    .A(_0764_));
 sg13g2_nor2b_1 _1309_ (.A(_0762_),
    .B_N(_0617_),
    .Y(_0766_));
 sg13g2_a21oi_1 _1310_ (.A1(_0758_),
    .A2(_0766_),
    .Y(_0767_),
    .B1(_0764_));
 ...
 sg13g2_xor2_1 _1316_ (.B(_0772_),
    .A(_0767_),
    .X(_0773_));
 sg13g2_a21oi_1 _1317_ (.A1(_0769_),
    .A2(_0773_),
    .Y(_0774_),
    .B1(_0604_));
 sg13g2_xor2_1 _1318_ (.B(_0773_),
    .A(_0769_),
    .X(_0775_));
 sg13g2_a21oi_1 _1319_ (.A1(net16),
    .A2(_0775_),
    .Y(_0776_),
    .B1(_0768_));
 ...
 sg13g2_nand4_1 _1330_ (.B(net50),
    ...
    .Y(_0787_),
    .D(_0565_));
 sg13g2_a21oi_1 _1331_ (.A1(_0786_),
    .A2(_0787_),
    .Y(_0788_),
    .B1(net68));
 sg13g2_a21oi_1 _1332_ (.A1(net69),
    .A2(_0783_),
    .Y(_0789_),
    .B1(_0788_));
 sg13g2_nand2_1 _1333_ (.Y(_0790_),
    .A(_0785_),
    .B(_0789_));
 sg13g2_a21oi_1 _1334_ (.A1(_0776_),
    .A2(_0779_),
    .Y(_0791_),
    .B1(_0753_));
 ...
 sg13g2_nand2_1 _1379_ (.Y(_0836_),
    .A(\fmax[4][0] ),
    .B(_0835_));
 sg13g2_inv_1 _1380_ (.Y(_0837_),
    .A(_0836_));
 sg13g2_a21oi_1 _1381_ (.A1(_0831_),
    .A2(_0832_),
    .Y(_0838_),
    .B1(_0829_));
 ...
 sg13g2_xnor2_1 _1386_ (.Y(_0843_),
    .A(_0822_),
    .B(_0825_));
 sg13g2_a21oi_1 _1387_ (.A1(_0841_),
    .A2(_0842_),
    .Y(_0844_),
    .B1(_0827_));
 ...
 sg13g2_xnor2_1 _1389_ (.Y(_0846_),
    .A(_0808_),
    .B(_0812_));
 sg13g2_a21oi_1 _1390_ (.A1(_0845_),
    .A2(_0846_),
    .Y(_0847_),
    .B1(_0813_));
 ...
 sg13g2_nor2b_1 _1393_ (.A(net20),
    .B_N(_0797_),
    .Y(_0850_));
 sg13g2_a21oi_1 _1394_ (.A1(net20),
    .A2(_0849_),
    .Y(_0851_),
    .B1(_0850_));
 sg13g2_a21oi_1 _1395_ (.A1(\hacc[0][5] ),
    .A2(net29),
    .Y(_0852_),
    .B1(_0851_));
 ...
 sg13g2_xnor2_1 _1403_ (.Y(_0860_),
    .A(_0820_),
    .B(_0844_));
 sg13g2_a21oi_1 _1404_ (.A1(_0575_),
    .A2(_0860_),
    .Y(_0861_),
    .B1(_0859_));
 ...
 sg13g2_and2_1 _1411_ (.A(\hacc[0][1] ),
    .B(net29),
    .X(_0868_));
 sg13g2_a21oi_1 _1412_ (.A1(_0833_),
    .A2(_0839_),
    .Y(_0869_),
    .B1(_0836_));
 ...
 sg13g2_nor2b_1 _1419_ (.A(_0875_),
    .B_N(_0873_),
    .Y(_0876_));
 sg13g2_inv_1 _1420_ (.Y(_0877_),
    .A(_0876_));
 sg13g2_a21oi_1 _1421_ (.A1(_0870_),
    .A2(_0871_),
    .Y(_0878_),
    .B1(_0868_));
 ...
 sg13g2_nor3_1 _1423_ (.A(_0872_),
    ...
    .C(_0878_),
    .Y(_0880_));
 sg13g2_a21oi_1 _1424_ (.A1(_0876_),
    .A2(_0879_),
    .Y(_0881_),
    .B1(_0872_));
 ...
 sg13g2_nand2b_1 _1428_ (.Y(_0885_),
    .B(_0884_),
    .A_N(_0862_));
 sg13g2_a21oi_1 _1429_ (.A1(_0883_),
    .A2(_0884_),
    .Y(_0886_),
    .B1(_0862_));
 ...
 sg13g2_nand2_1 _1439_ (.Y(_0896_),
    .A(_0889_),
    .B(_0891_));
 sg13g2_a21oi_1 _1440_ (.A1(_0889_),
    .A2(_0891_),
    .Y(_0897_),
    .B1(_0852_));
 sg13g2_a21oi_1 _1441_ (.A1(_0890_),
    .A2(_0895_),
    .Y(_0898_),
    .B1(_0897_));
 sg13g2_a21oi_1 _1442_ (.A1(net162),
    .A2(net28),
    .Y(_0899_),
    .B1(_0898_));
 ...
 sg13g2_nand2_1 _1446_ (.Y(_0902_),
    .A(\osum[1] ),
    .B(net28));
 sg13g2_a221oi_1 _1447_ (.B2(_0853_),
    .C1(net64),
    .B1(_0896_),
    .A1(_0890_),
    .Y(_0903_),
 ...
 sg13g2_nand2_1 _1450_ (.Y(_0906_),
    .A(_0890_),
    .B(_0905_));
 sg13g2_a21oi_1 _1451_ (.A1(_0890_),
    .A2(_0905_),
    .Y(_0907_),
    .B1(_0897_));
 ...
 sg13g2_a21o_1 _1464_ (.A2(_0918_),
    ...
    .B1(_0897_),
    .X(_0919_));
 sg13g2_a21oi_1 _1465_ (.A1(net72),
    .A2(_0907_),
    .Y(_0920_),
    .B1(_0903_));
 ...
 sg13g2_xnor2_1 _1469_ (.Y(_0924_),
    .A(_0915_),
    .B(_0923_));
 sg13g2_a21oi_1 _1470_ (.A1(net25),
    .A2(_0924_),
    .Y(_0007_),
    .B1(_0914_));
 sg13g2_a21oi_1 _1471_ (.A1(_0915_),
    .A2(_0923_),
    .Y(_0925_),
    .B1(_0922_));
 sg13g2_nand2_1 _1472_ (.Y(_0926_),
    .A(\osum[3] ),
    .B(_0625_));
 sg13g2_a21oi_1 _1473_ (.A1(_0919_),
    .A2(_0920_),
    .Y(_0927_),
    .B1(net64));
 ...
 sg13g2_nand3b_1 _1475_ (.B(_0892_),
    ...
    .Y(_0929_),
    .A_N(_0888_));
 sg13g2_a21oi_1 _1476_ (.A1(_0890_),
    .A2(_0929_),
    .Y(_0930_),
    .B1(_0897_));
 ...
 sg13g2_nand2b_1 _1478_ (.Y(_0932_),
    .B(_0931_),
    .A_N(_0926_));
 sg13g2_a21oi_1 _1479_ (.A1(\osum[3] ),
    .A2(_0625_),
    .Y(_0933_),
    .B1(_0931_));
 ...
 sg13g2_o21ai_1 _1484_ (.B1(_0932_),
    ...
    .A1(_0925_),
    .A2(_0933_));
 sg13g2_a21oi_1 _1485_ (.A1(net72),
    .A2(_0930_),
    .Y(_0938_),
    .B1(_0927_));
 sg13g2_inv_1 _1486_ (.Y(_0939_),
    .A(_0938_));
 ...
 sg13g2_mux2_1 _1488_ (.A0(\osum[4] ),
    ...
    .S(_0938_),
    .X(_0941_));
 sg13g2_inv_1 _1489_ (.Y(_0942_),
    .A(_0941_));
 sg13g2_xnor2_1 _1490_ (.Y(_0943_),
    .A(_0937_),
    .B(_0942_));
 sg13g2_a21oi_1 _1491_ (.A1(net25),
    .A2(_0943_),
    .Y(_0009_),
    .B1(_0936_));
 ...
 sg13g2_xnor2_1 _1503_ (.Y(_0954_),
    .A(_0951_),
    .B(_0953_));
 sg13g2_a21oi_1 _1504_ (.A1(net24),
    .A2(_0954_),
    .Y(_0011_),
    .B1(_0950_));
 ...
 sg13g2_and2_1 _1510_ (.A(net7),
    .B(_0959_),
    .X(_0960_));
 sg13g2_a21oi_1 _1511_ (.A1(net8),
    .A2(_0960_),
    .Y(_0961_),
    .B1(net9));
 sg13g2_or2_1 _1512_ (.X(_0962_),
    .B(_0959_),
    .A(net7));
 ...
 sg13g2_nand2_1 _1521_ (.Y(_0971_),
    .A(net3),
    .B(_0913_));
 sg13g2_a21oi_1 _1522_ (.A1(_0924_),
    .A2(_0971_),
    .Y(_0972_),
    .B1(_0970_));
 ...
 sg13g2_o21ai_1 _1527_ (.B1(_0966_),
    ...
    .A1(_0974_),
    .A2(_0976_));
 sg13g2_or2_1 _1528_ (.X(_0978_),
    .B(_0962_),
    .A(net8));
 sg13g2_nand2_1 _1529_ (.Y(_0979_),
    .A(net24),
    .B(_0595_));
 sg13g2_a21oi_1 _1530_ (.A1(net9),
    .A2(_0978_),
    .Y(_0980_),
    .B1(_0979_));
 sg13g2_o21ai_1 _1531_ (.B1(_0980_),
    ...
    .A1(_0954_),
    .A2(_0961_));
 sg13g2_a21oi_1 _1532_ (.A1(_0964_),
    .A2(_0977_),
    .Y(_0982_),
    .B1(_0981_));
 ...
 sg13g2_o21ai_1 _1539_ (.B1(net363),
    ...
    .A1(\hold[0] ),
    .A2(\hold[1] ));
 sg13g2_a21oi_1 _1540_ (.A1(_0536_),
    .A2(_0987_),
    .Y(_0988_),
    .B1(_0955_));
 ...
 sg13g2_nand2_1 _1542_ (.Y(_0989_),
    .A(net348),
    .B(_0536_));
 sg13g2_a21oi_1 _1543_ (.A1(_0537_),
    .A2(_0989_),
    .Y(_0990_),
    .B1(_0955_));
 ...
 sg13g2_nor2_1 _1546_ (.A(net168),
    .B(_0982_),
    .Y(_0992_));
 sg13g2_a21oi_1 _1547_ (.A1(_0956_),
    .A2(net169),
    .Y(_0016_),
    .B1(_0992_));
 ...
 sg13g2_xor2_1 _1576_ (.B(_1013_),
    .A(net353),
    .X(_0024_));
 sg13g2_a21oi_1 _1577_ (.A1(net353),
    .A2(_1013_),
    .Y(_1014_),
    .B1(net361));
 ...
 sg13g2_xnor2_1 _1585_ (.Y(_0028_),
    .A(net362),
    .B(_1017_));
 sg13g2_a21oi_1 _1586_ (.A1(\cnt[11] ),
    .A2(_1018_),
    .Y(_1019_),
    .B1(net283));
 ...
 sg13g2_xor2_1 _1589_ (.B(_1020_),
    .A(net160),
    .X(_0030_));
 sg13g2_a21oi_1 _1590_ (.A1(_1000_),
    .A2(_1012_),
    .Y(_1021_),
    .B1(net355));
 ...
 sg13g2_nor2_1 _1593_ (.A(_0955_),
    .B(_1004_),
    .Y(_1023_));
 sg13g2_a21oi_1 _1594_ (.A1(_0519_),
    .A2(_1022_),
    .Y(_0032_),
    .B1(_1023_));
 ...
 sg13g2_nor4_1 _1599_ (.A(_0509_),
    ...
    .D(_1004_),
    .Y(_1026_));
 sg13g2_a21oi_1 _1600_ (.A1(_0544_),
    .A2(_1023_),
    .Y(_1027_),
    .B1(net78));
 ...
 sg13g2_a21o_1 _1604_ (.A2(net27),
    ...
    .B1(_1028_),
    .X(_1029_));
 sg13g2_inv_1 _1605_ (.Y(_1030_),
    .A(_1029_));
 sg13g2_a21oi_1 _1606_ (.A1(_0994_),
    .A2(net27),
    .Y(_1031_),
    .B1(net77));
 sg13g2_a21oi_1 _1607_ (.A1(net77),
    .A2(_1029_),
    .Y(_0037_),
    .B1(_1031_));
 ...
 sg13g2_nand2_1 _1609_ (.Y(_1033_),
    .A(net76),
    .B(net77));
 sg13g2_a21oi_1 _1610_ (.A1(net27),
    .A2(_1033_),
    .Y(_1034_),
    .B1(_1030_));
 sg13g2_a21oi_1 _1611_ (.A1(net77),
    .A2(_1029_),
    .Y(_1035_),
    .B1(net76));
 sg13g2_nor2_1 _1612_ (.A(_1034_),
    .B(net416),
    .Y(_0038_));
 sg13g2_a21oi_1 _1613_ (.A1(_0996_),
    .A2(_1032_),
    .Y(_1036_),
    .B1(net75));
 ...
 sg13g2_a22oi_1 _1618_ (.Y(_0040_),
    ...
    .A2(_1038_),
    .A1(_1034_));
 sg13g2_a21oi_1 _1619_ (.A1(net371),
    .A2(_0595_),
    .Y(_1040_),
    .B1(_0540_));
 sg13g2_or2_1 _1620_ (.X(_1041_),
    .B(_1005_),
    .A(_0994_));
 ...
 sg13g2_nor2_1 _1631_ (.A(net151),
    .B(net39),
    .Y(_0209_));
 sg13g2_a21oi_1 _1632_ (.A1(_0523_),
    .A2(net39),
    .Y(_0045_),
    .B1(_0209_));
 sg13g2_nor2_1 _1633_ (.A(net329),
    .B(net35),
    .Y(_0210_));
 sg13g2_a21oi_1 _1634_ (.A1(_0522_),
    .A2(net35),
    .Y(_0046_),
    .B1(_0210_));
 ...
 sg13g2_nor2_1 _1640_ (.A(net350),
    .B(net46),
    .Y(_0211_));
 sg13g2_a21oi_1 _1641_ (.A1(_0524_),
    .A2(net42),
    .Y(_0052_),
    .B1(_0211_));
 sg13g2_nor2_1 _1642_ (.A(net163),
    .B(net44),
    .Y(_0212_));
 sg13g2_a21oi_1 _1643_ (.A1(_0526_),
    .A2(net44),
    .Y(_0053_),
    .B1(_0212_));
 ...
 sg13g2_nor2_1 _1717_ (.A(net74),
    .B(net75),
    .Y(_0215_));
 sg13g2_or2_1 _1718_ (.X(_0216_),
    .B(net74),
    .A(net76));
 sg13g2_a21oi_1 _1719_ (.A1(\cnt[6] ),
    .A2(\stg[0] ),
    .Y(_0217_),
    .B1(net74));
 sg13g2_a21oi_1 _1720_ (.A1(\cnt[13] ),
    .A2(\stg[1] ),
    .Y(_0218_),
    .B1(\cnt[8] ));
 ...
 sg13g2_nand2_1 _1725_ (.Y(_0223_),
    .A(_0521_),
    .B(_0993_));
 sg13g2_a221oi_1 _1726_ (.B2(\cnt[4] ),
    .C1(\cnt[3] ),
    .B1(_0223_),
    .A1(_0216_),
    .Y(_0224_),
 ...
 sg13g2_o21ai_1 _1727_ (.B1(\cnt[12] ),
    ...
    .A1(net76),
    .A2(net77));
 sg13g2_a21oi_1 _1728_ (.A1(\cnt[14] ),
    .A2(_1032_),
    .Y(_0226_),
    .B1(\cnt[11] ));
 sg13g2_a21oi_1 _1729_ (.A1(_0225_),
    .A2(_0226_),
    .Y(_0227_),
    .B1(_1037_));
 ...
 sg13g2_o21ai_1 _1741_ (.B1(_0238_),
    ...
    .A1(_0215_),
    .A2(_0224_));
 sg13g2_inv_1 _1742_ (.Y(_0240_),
    .A(net13));
 sg13g2_nand2_1 _1743_ (.Y(_0241_),
    .A(\ring[8][2] ),
    .B(net31));
 sg13g2_or2_1 _1744_ (.X(_0242_),
    .B(_0241_),
    .A(\casc_st[2] ));
 ...
 sg13g2_nand2_1 _1746_ (.Y(_0244_),
    .A(\ring[8][1] ),
    .B(net31));
 sg13g2_a21oi_1 _1747_ (.A1(\ring[8][1] ),
    .A2(net31),
    .Y(_0245_),
    .B1(_0522_));
 ...
 sg13g2_nand2_1 _1749_ (.Y(_0247_),
    .A(\ring[8][0] ),
    .B(net31));
 sg13g2_a21oi_1 _1750_ (.A1(\ring[8][0] ),
    .A2(net31),
    .Y(_0248_),
    .B1(_0523_));
 ...
 sg13g2_nor2_1 _1755_ (.A(net13),
    .B(_0252_),
    .Y(_0253_));
 sg13g2_a21oi_1 _1756_ (.A1(net370),
    .A2(net13),
    .Y(_0254_),
    .B1(_0253_));
 sg13g2_a21oi_1 _1757_ (.A1(net26),
    .A2(_0254_),
    .Y(_0125_),
    .B1(_0214_));
 ...
 sg13g2_o21ai_1 _1780_ (.B1(net26),
    ...
    .A1(net331),
    .A2(net10));
 sg13g2_a21oi_1 _1781_ (.A1(net10),
    .A2(_0275_),
    .Y(_0277_),
    .B1(_0276_));
 ...
 sg13g2_a21o_1 _1784_ (.A2(_0273_),
    ...
    .B1(_0272_),
    .X(_0279_));
 sg13g2_a21oi_1 _1785_ (.A1(_0269_),
    .A2(_0270_),
    .Y(_0280_),
    .B1(_0268_));
 ...
 sg13g2_o21ai_1 _1808_ (.B1(net26),
    ...
    .A1(net232),
    .A2(net10));
 sg13g2_a21oi_1 _1809_ (.A1(net10),
    .A2(_0301_),
    .Y(_0303_),
    .B1(_0302_));
 ...
 sg13g2_nand2_1 _1811_ (.Y(_0304_),
    .A(net143),
    .B(net41));
 sg13g2_a21oi_1 _1812_ (.A1(_0292_),
    .A2(_0299_),
    .Y(_0305_),
    .B1(_0298_));
 sg13g2_and2_1 _1813_ (.A(_0525_),
    .B(net32),
    .X(_0306_));
 sg13g2_or2_1 _1814_ (.X(_0307_),
    .B(_0306_),
    .A(\casc_st[7] ));
 sg13g2_xnor2_1 _1815_ (.Y(_0308_),
    .A(\casc_st[7] ),
    .B(_0306_));
 sg13g2_a21oi_1 _1816_ (.A1(_0295_),
    .A2(_0296_),
    .Y(_0309_),
    .B1(_0294_));
 ...
 sg13g2_nor2_1 _1826_ (.A(pdm_bit),
    .B(net32),
    .Y(_0318_));
 sg13g2_a21oi_1 _1827_ (.A1(\ring[8][8] ),
    .A2(net32),
    .Y(_0319_),
    .B1(_0318_));
 ...
 sg13g2_o21ai_1 _1836_ (.B1(net26),
    ...
    .A1(\casc_st[6] ),
    .A2(net11));
 sg13g2_a21oi_1 _1837_ (.A1(net11),
    .A2(_0327_),
    .Y(_0329_),
    .B1(_0328_));
 sg13g2_a21o_1 _1838_ (.A2(net41),
    ...
    .B1(_0329_),
    .X(_0131_));
 sg13g2_a21oi_1 _1839_ (.A1(_0316_),
    .A2(_0325_),
    .Y(_0330_),
    .B1(_0324_));
 sg13g2_a21oi_1 _1840_ (.A1(_0317_),
    .A2(_0321_),
    .Y(_0331_),
    .B1(_0320_));
 sg13g2_a21oi_1 _1841_ (.A1(\ring[8][9] ),
    .A2(net32),
    .Y(_0332_),
    .B1(_0318_));
 ...
 sg13g2_xor2_1 _1846_ (.B(_0336_),
    .A(_0330_),
    .X(_0337_));
 sg13g2_a21oi_1 _1847_ (.A1(_0524_),
    .A2(net13),
    .Y(_0338_),
    .B1(net43));
 ...
 sg13g2_o21ai_1 _1855_ (.B1(net27),
    ...
    .A1(net341),
    .A2(net11));
 sg13g2_a21oi_1 _1856_ (.A1(net11),
    .A2(_0344_),
    .Y(_0346_),
    .B1(_0345_));
 ...
 sg13g2_nand2_1 _1858_ (.Y(_0347_),
    .A(net145),
    .B(net43));
 sg13g2_a21oi_1 _1859_ (.A1(_0342_),
    .A2(_0343_),
    .Y(_0348_),
    .B1(_0340_));
 ...
 sg13g2_nor2b_1 _1865_ (.A(\stg[3] ),
    .B_N(\stg[2] ),
    .Y(_0353_));
 sg13g2_a21oi_1 _1866_ (.A1(uio_out[5]),
    .A2(_0353_),
    .Y(_0354_),
    .B1(_0995_));
 ...
 sg13g2_xnor2_1 _1918_ (.Y(_0390_),
    .A(_0241_),
    .B(_0275_));
 sg13g2_a21oi_1 _1919_ (.A1(_0389_),
    .A2(_0390_),
    .Y(_0391_),
    .B1(_0385_));
 sg13g2_a21oi_1 _1920_ (.A1(_0383_),
    .A2(_0391_),
    .Y(_0392_),
    .B1(_0384_));
 sg13g2_a21oi_1 _1921_ (.A1(_0382_),
    .A2(_0392_),
    .Y(_0393_),
    .B1(_0381_));
 ...
 sg13g2_nand2_1 _1927_ (.Y(_0399_),
    .A(_0332_),
    .B(_0350_));
 sg13g2_a21oi_1 _1928_ (.A1(_0373_),
    .A2(_0396_),
    .Y(_0400_),
    .B1(_0372_));
 ...
 sg13g2_nor2_1 _1941_ (.A(_0401_),
    .B(_0411_),
    .Y(_0413_));
 sg13g2_a21oi_1 _1942_ (.A1(_0411_),
    .A2(_0412_),
    .Y(_0414_),
    .B1(_0401_));
 ...
 sg13g2_xor2_1 _1944_ (.B(_0413_),
    .A(_0412_),
    .X(_0416_));
 sg13g2_a21oi_1 _1945_ (.A1(_0403_),
    .A2(_0410_),
    .Y(_0417_),
    .B1(_0401_));
 ...
 sg13g2_a21o_1 _1962_ (.A2(_0433_),
    ...
    .B1(_0425_),
    .X(_0434_));
 sg13g2_a21oi_1 _1963_ (.A1(_0422_),
    .A2(_0434_),
    .Y(_0435_),
    .B1(_0420_));
 ...
 sg13g2_nor2_1 _1966_ (.A(_0399_),
    .B(_0400_),
    .Y(_0438_));
 sg13g2_a21oi_1 _1967_ (.A1(_0398_),
    .A2(_0400_),
    .Y(_0439_),
    .B1(_0438_));
 sg13g2_inv_1 _1968_ (.Y(_0440_),
    .A(_0439_));
 ...
 sg13g2_and2_1 _1970_ (.A(_0415_),
    .B(_0416_),
    .X(_0442_));
 sg13g2_inv_1 _1971_ (.Y(_0443_),
    .A(_0442_));
 sg13g2_or2_1 _1972_ (.X(_0444_),
    .B(_0420_),
    .A(_0418_));
 sg13g2_nand2_1 _1973_ (.Y(_0445_),
    .A(_0422_),
    .B(_0426_));
 sg13g2_a21oi_1 _1974_ (.A1(_0430_),
    .A2(_0433_),
    .Y(_0446_),
    .B1(_0445_));
 ...
 sg13g2_o21ai_1 _1998_ (.B1(_0459_),
    ...
    .A1(_0448_),
    .A2(_0453_));
 sg13g2_a21oi_1 _1999_ (.A1(_0451_),
    .A2(_0470_),
    .Y(_0471_),
    .B1(_0443_));
 sg13g2_inv_1 _2000_ (.Y(_0472_),
    .A(_0471_));
 ...
 sg13g2_o21ai_1 _2007_ (.B1(_0478_),
    ...
    .A1(_0476_),
    .A2(_0477_));
 sg13g2_a21oi_1 _2008_ (.A1(_0450_),
    .A2(_0459_),
    .Y(_0480_),
    .B1(_0443_));
 sg13g2_nor2_1 _2009_ (.A(uo_out[7]),
    .B(_0480_),
    .Y(_0481_));
 sg13g2_a21oi_1 _2010_ (.A1(_0513_),
    .A2(_0472_),
    .Y(_0482_),
    .B1(_0481_));
 sg13g2_a21oi_1 _2011_ (.A1(_0479_),
    .A2(_0482_),
    .Y(_0483_),
    .B1(net13));
 ...
 sg13g2_nand3_1 _2014_ (.B(_0483_),
    ...
    .A(_0469_),
    .Y(_0486_));
 sg13g2_a21oi_1 _2015_ (.A1(_0483_),
    .A2(_0484_),
    .Y(_0487_),
    .B1(net406));
 ...
 sg13g2_nor2_1 _2065_ (.A(\hacc[6][0] ),
    .B(net56),
    .Y(_0497_));
 sg13g2_a21oi_1 _2066_ (.A1(_0527_),
    .A2(net56),
    .Y(_0191_),
    .B1(_0497_));
 sg13g2_nor2_1 _2067_ (.A(\hacc[6][1] ),
    .B(net56),
    .Y(_0498_));
 sg13g2_a21oi_1 _2068_ (.A1(_0528_),
    .A2(net56),
    .Y(_0192_),
    .B1(_0498_));
 sg13g2_nor2_1 _2069_ (.A(\hacc[6][2] ),
    .B(net60),
    .Y(_0499_));
 sg13g2_a21oi_1 _2070_ (.A1(_0529_),
    .A2(net60),
    .Y(_0193_),
    .B1(_0499_));
 ...
 sg13g2_nor2_1 _2072_ (.A(\hacc[6][4] ),
    .B(net57),
    .Y(_0500_));
 sg13g2_a21oi_1 _2073_ (.A1(_0530_),
    .A2(net62),
    .Y(_0195_),
    .B1(_0500_));
 sg13g2_mux2_1 _2074_ (.A0(\hacc[6][5] ),
    ...
    .S(net59),
    .X(_0196_));
 sg13g2_a21oi_1 _2075_ (.A1(_0852_),
    .A2(_0889_),
    .Y(_0501_),
    .B1(_0540_));
 ...
 sg13g2_tiehi tt_um_wakeword_122 (.L_HI(net122));
 sg13g2_tiehi tt_um_wakeword_123 (.L_HI(net123));
 sg13g2_tiehi tt_um_wakeword_124 (.L_HI(net124));
 sg13g2_tiehi tt_um_wakeword_125 (.L_HI(net125));
 sg13g2_tiehi tt_um_wakeword_126 (.L_HI(net126));
 sg13g2_tiehi tt_um_wakeword_127 (.L_HI(net127));
 sg13g2_tiehi tt_um_wakeword_128 (.L_HI(net128));
 assign uio_oe[0] = net;
