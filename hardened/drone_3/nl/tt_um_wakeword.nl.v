module tt_um_wakeword (clk,
 ...
 sg13g2_nor2_1 _1554_ (.A(uio_out[6]),
    .B(uio_out[5]),
    .Y(_0999_));
 sg13g2_a21oi_1 _1555_ (.A1(net401),
    .A2(_0999_),
    .Y(_1000_),
    .B1(_0998_));
 ...
 sg13g2_a21oi_1 _1561_ (.A1(net34),
    ...
    .Y(_1005_),
    .B1(_1000_));
 sg13g2_a21oi_1 _1562_ (.A1(net356),
    .A2(_1001_),
    .Y(_1006_),
    .B1(net68));
 ...
 sg13g2_inv_1 clkload12 (.A(clknet_leaf_32_clk));
 sg13g2_inv_1 clkload13 (.A(clknet_leaf_26_clk));
 sg13g2_inv_1 clkload14 (.A(clknet_leaf_12_clk));
 sg13g2_inv_1 clkload15 (.A(clknet_leaf_13_clk));
 ...
 sg13g2_inv_1 clkload8 (.A(clknet_leaf_9_clk));
